# -*- coding: utf-8 -*-
"""President_Botrick
This portion of the code consists of the classification task, using BERT to predict persuasive and impactful texts
"""
...
datarray = []
linearray = []
good_output = open('good_output.txt', 'w')
bad_output = open('bad_output.txt', 'w')
...
print(datarray[10])
print(linearray[10])
files.download('bad_output.txt')
print(len(datarray))
print(len(linearray))

maxlen = 200
tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', do_lower_case=True, model_max_length=maxlen) #tokenizer converts sentences to numerical values
...
torch.save(model.state_dict(), "/content/drive/MyDrive/President_Botrick/model0315.pt")
